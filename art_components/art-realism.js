...
class ArtRealism extends Component {
  render() {
    const imageItems = [
        ...
        {
            src: require("/art/chris-evans.jpg"),
        ...
        {
            src: require("/art/noahcentineo.jpg"),
        ...
        {
            src: require("/art/man-digital2.jpg"),
