    ...
    return (
      <div className="light-container">            
        ...
        <Row>
          ...
          <Col md={2}>
          <img src={require('/logo-kordinglab.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
          <Col md={2}></Col>
          <Col md={3}>
            <h3><b>2019</b></h3>
          ...
          <Col md={2}>
          <img src={require('/logo-penn.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
        </Row>
        <Row>
          <Col md={3}>
          ...
          <Col md={2}>
          <img src={require('/logo-unilever.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
          <Col md={2}></Col>
          <Col md={3}>
            <h3><b>2018</b></h3>
          ...
          <Col md={2}>
          <img src={require('/logo-tovala.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
        </Row>
        <Row>
          <Col md={3}>
          ...
          <Col md={2}>
          <img src={require('/logo-cni.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
          <Col md={2}></Col>
          <Col md={3}>
            <h3><b>2015</b></h3>
          ...
          <Col md={2}>
          <img src={require('/logo-cmu.png')} style={{display: "block", padding: "5%", height: "12vw"}}alt="Logo WV"/>
          </Col>
        </Row>
        </div>
      </div>
