      ...
      <div className="dark-container">            
        ...
        <Row>
          ...
          <Row>
            ...
            <Col md={3}>
              <img src={require('../public/static/logo-penn.png')} style={{display: "block", padding: "5%", width: "300px"}}alt="Logo Penn"/>
            </Col>
          </Row>
          <Row>
            <Col md={9}>
            ...
            <Col md={3}>
              <img src={require('../public/static/logo-wv.png')} style={{display: "block", padding: "5%", width: "300px"}}alt="Logo WV"/>
            </Col>
          </Row>
          </Col>
        </Row>
