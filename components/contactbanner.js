    ...
    return (          
        ...
        <Row>
          ...
          <Fade bottom duration={5000}>
            ...
            <img src={require('../public/static/logo-linkedin.png')} style={{display: "block", padding: "5%", height: "100px", width: "100px"}}alt="Logo WV"/>
            </NavLink>
            <NavLink href="https://www.facebook.com/jordan.lei.77" target="_blank">
              <img src={require('../public/static/logo-fb.png')} style={{display: "block", padding: "5%", height: "100px"}}alt="Logo WV"/>
            </NavLink>
            <NavLink href="https://www.instagram.com/leijordanart/" target="_blank">
            <img src={require('../public/static/logo-insta.png')} style={{display: "block", padding: "5%", height: "100px", width: "100px"}}alt="Logo WV"/>
            </NavLink>
            </Row>
